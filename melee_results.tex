...
\subsubsection[Adjacent Units]{} Units adjacent to friendly units routed in melee by opponents in Charge or Attack \& Pursue order must check morale. Disruption results are textit{ignore}; rout results apply. Case 9.62 has precedence over this case, however.
