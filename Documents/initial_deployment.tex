...
\textbf{F/T} = Fyrd/Thegn; \textbf{HC} = Housecarl; \textbf{B} = Bowmen. \textbf{Harold is placed in hex 0514;} \textbf{Leofwine} in hex 0710; and \textbf{Gyrth} in 0721. Each leader shares the hex with the unit indicated by the map's setup marking: Harold with a Housecarl, and Leofwine and Gyrth with a Fyrd/Thegn unit. The units can face in any direction.
