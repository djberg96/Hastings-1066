...
\begin{center}
  \begin{noverticalspace}
    \includegraphics[scale=0.40]{Norman_Battle_Order_Determination_Table_Knights.png}
...
\begin{center}
  \begin{noverticalspace}
    \includegraphics[scale=0.40]{Norman_Battle_Order_Display_Knights.png}
    \includegraphics[scale=0.40]{Norman_Battle_Order_Display_Foot.png}
  \end{noverticalspace}
\end{center}
